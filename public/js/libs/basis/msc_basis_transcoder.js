var MSC_TRANSCODER = (function () {
  ...
  return function (MSC_TRANSCODER) {
    ...
    var Module = typeof MSC_TRANSCODER !== 'undefined' ? MSC_TRANSCODER : {};
    var moduleOverrides = {};
    var key;
    for (key in Module) {
    ...
    var wasmBinaryFile = 'msc_basis_transcoder.wasm';
...
if (typeof exports === 'object' && typeof module === 'object')
  module.exports = MSC_TRANSCODER;
else if (typeof define === 'function' && define['amd'])
  define([], function () {
    return MSC_TRANSCODER;
  });
else if (typeof exports === 'object')
  exports['MSC_TRANSCODER'] = MSC_TRANSCODER;
